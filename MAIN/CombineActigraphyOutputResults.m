function CombineActigraphyOutputResults(FoundVideoFilesPath,BBParentPath,GeneralOutputsPath,BBlist,BBToAnalyze)
...
bbIDs = BBlist; %{'02','04','06','09','12','14','15','17'}; % Note these will be overwritten by those loaded from the output_found_videos_file_name
