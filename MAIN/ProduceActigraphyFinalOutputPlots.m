function ProduceActigraphyFinalOutputPlots(FoundVideoFilesPath,GeneralOutputsPath,BBlist,BBToAnalyze)
...
general_output_settings.rootPath = GeneralOutputsPath;
...
output_found_videos_file_name = fullfile(FoundVideoFilesPath,'FoundVideoFiles.mat');%'C:\Users\duck7\Documents\lab shit\FoundVideoFiles.mat';
...
for i=1:num_boxes_to_process
    ...
    if current_included_bbIDs(i)
        ...
        disp('Making figures...')
        [fig, axH] = PlotBinnedActigraphyEventsTimetable(curr_activity_timetable_hourly_binned_mean, video_frames_per_bin, currBBIDString, 'hourly', 'mean', curr_output_plots_path, aggregateGroupings, curr_activity_timetable);
        [fig, axH] = PlotBinnedActigraphyEventsTimetable(curr_activity_timetable_hourly_binned_sum, video_frames_per_bin, currBBIDString, 'hourly', 'sum', curr_output_plots_path, aggregateGroupings, curr_activity_timetable);
        disp('done.')
